...
!function () {
    window.HE = {
        ...
        handyEditor: function (id, options) {
            ...
            mwdiv.style.zIndex = "9000", this.define.mwobj = mwdiv, mwdiv.appendChild(mdiv), hediv.appendChild(mwdiv), this.define.mobj = mdiv, hediv.appendChild(ediv), this.define.hobj = hediv, heparent = hetxt.parentNode, heparent.insertBefore(hediv, hetxt), this.define.obj.innerHTML = hetxt.value, this.define.hetxt = hetxt;
            for (var i in this.config.item) {
                var icon = this.trim(this.config.item[i].toLowerCase());
                if ("|" != icon) {
            ...
            this.define.obj.onclick = this.editorClick, this.define.mobj.onclick = this.menukongClick, this.config.autoFloat && (window.onscroll = function () {
                ...
                if (13 == (i.keyCode || i.which || i.charCode)) {
                    HE.informat(["li", "pre"]) || HE.handy("formatBlock", "<p>", !0)
                }
        ...
        newdiv: function (e) {
            if (HE.define.mobj.blur(), document.getElementById("HandyEditor_newdiv")) HE.deldiv(); else {
                ...
                if (n.className = "HandyEditor_newdiv", n.id = "HandyEditor_newdiv", "fontsize" == e) for (var d = [14, 16, 18, 24, 32, 48], t = '<div class="HandyEditor_newdiv_down" id="HandyEditor_newdiv_down_1" style="font-size:10px;" draggable="true">' + HE.define.lang.fontsize + "</div>", o = 0; o < d.length; o++) t += '<div class="HandyEditor_newdiv_gap"></div><div class="HandyEditor_newdiv_down" id="HandyEditor_newdiv_down_' + (o + 2) + '" style="font-size:' + d[o] + 'px;" draggable="true">' + HE.define.lang.fontsize + "</div>"; else if ("fontname" == e) {
                ...
                } else if ("backcolor" == e) l = HE.getColor(), t = "<div>" + HE.define.lang.backcolor + ': <input style="border : solid 2px #ddd;padding: 5px;" type="text" id="HandyEditor_newdiv_down_backcolor" /><span class="HandyEditor_menu_item" id="HandyEditor_newdiv_down_backcolorok" style="display: inline-block;margin-left: 10px;" draggable="true">' + HE.define.lang.affirm + "</span></div><div>" + HE.define.lang.basecolor + '</div><div class="HandyEditor_newdiv_gap"></div><div>' + l[0] + "</div><div>" + HE.define.lang.topicolor + '</div><div class="HandyEditor_newdiv_gap"></div><div>' + l[1] + "</div>"; else if ("link" == e) t = "<div>" + HE.define.lang.urladdr + ': <input style="border : solid 1px #ddd;padding: 5px;" type="text" id="HandyEditor_newdiv_down_link" /><span class="HandyEditor_menu_item" id="HandyEditor_newdiv_down_linkok" style="display: inline-block;margin-left: 10px;" draggable="true">' + HE.define.lang.affirm + "</span></div>"; else if ("code" == e) {
                    t = "";
                    ...
                    if (1 == HE.config.uploadPhoto) {
                        var r = "", s = HE.config.uploadPhotoType.split(",");
        ...
        html: function () {
            if (0 == HE.define.html) {
                ...
                i.className = "HandyEditor_newtextarea_textarea", i.style.width = "100%", i.style.height = "100%", i.style.border = "0px", i.style.padding = "10px", i.style.outline = "none", e.appendChild(i), HE.define.hetxt.parentNode.insertBefore(e, HE.define.hetxt), HE.define.taobj = e, HE.define.tarobj = i, HE.define.inh = HE.define.obj.innerHTML, HE.define.inh = HE.define.inh.replace(/<p>(\S)/g, "<p>\n    $1"), HE.define.inh = HE.define.inh.replace(/(\S)<br><\/p>/g, "$1</p>"), HE.define.inh = HE.define.inh.replace(/(\S)<\/p>/g, "$1\n</p>"), HE.define.inh = HE.define.inh.replace(/<\/p><p>/g, "</p>\n<p>"), HE.define.inh = HE.define.inh.replace(/<\/p></g, "</p>\n<"), HE.define.inh = HE.define.inh.replace(/><p>/g, ">\n<p>"), HE.define.inh = HE.define.inh.replace(/">(\S)/g, '">\n$1'), HE.define.inh = HE.define.inh.replace(/(\S)<\/pre>/g, "$1\n</pre>"), HE.define.inh = HE.define.inh.replace(/><li>/g, ">\n    <li>"), HE.define.inh = HE.define.inh.replace(/><\/ol>/g, ">\n</ol>"), HE.define.inh = HE.define.inh.replace(/><div>/g, ">\n<div>"), HE.define.tarobj.value = HE.define.inh, HE.define.html = !0, HE.hasClass(this, "HandyEditor_menu_item_valid") || HE.addClass(this, "HandyEditor_menu_item_valid");
                for (var n in HE.config.item) {
                    if ("|" != (d = HE.trim(HE.config.item[n].toLowerCase())) && "html" != d && "about" != d) (t = document.getElementById("HandyEditor_" + HE.define.id + "_" + d)).onclick = null, HE.hasClass(t, "HandyEditor_menu_item_invalid") || HE.addClass(t, "HandyEditor_menu_item_invalid")
                }
                ...
                for (var n in HE.config.item) {
                    var d, t;
                    if ("|" != (d = HE.trim(HE.config.item[n].toLowerCase())) && "html" != d && "about" != d) (t = document.getElementById("HandyEditor_" + HE.define.id + "_" + d)).onclick = HE[d], HE.hasClass(t, "HandyEditor_menu_item_invalid") && HE.removeClass(t, "HandyEditor_menu_item_invalid")
                }
            }
        }
    }
